...
<?php if ($comments) : ?>
	...
	<h4 id="comments">Комментарии. <?php comments_number('Пока нет комментариев', 'Есть 1 комментарий', 'Комментарии %.' );?></h4>
...
<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" class="form">
	...
	<p class="hello">Здравствуйте, <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Выйти">Выход &raquo;</a></p>
